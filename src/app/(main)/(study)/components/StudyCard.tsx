...
const StudyCard = ({ study }: { study: Study }) => {
  return (
    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 h-[587px] w-[640px] gap-2.5 p-5 rounded-[13px] bg-white shadow-lg">
      <Link href={`/recruit/${study.studyId}`}>
